    ...
    <>
      ...
      {foundUser ? (
        <div className="border rounded-xl p-4 mb-4">
          ...
          <form ref={sendFormRef} onSubmit={handleSend} className="space-y-4 mt-4">
            <div>
            ...
            <ActionBar
              onConfirm={() => sendFormRef.current?.requestSubmit()}
              confirmLabel="Enviar Notificação"
              confirmColor="bg-cm-blue text-white hover:bg-cm-blue/90"
              loading={loading}
              showConfirm={true}
              showCancel={false}
            />
        ...
        hasSearched && !searching && !foundUser && !error && (
