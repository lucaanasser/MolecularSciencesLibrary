...
const ForumHeader: React.FC = () => {
  return (
    <div className="relative bg-gradient-to-br from-cyan-50 via-white to-teal-50 border-b-2 border-cm-academic/20 py-8 px-6 overflow-hidden">
      {/* Padrão de fundo sutil */}
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-10 left-10 w-32 h-32 bg-cm-academic rounded-full blur-3xl"></div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-3xl font-semibold text-gray-800 leading-tight">
                  molec<span className="font-bold text-cm-academic">overflow</span>
                </span>
          ...
          <div className="flex items-center gap-6 text-sm">
            <div className="text-center">
              <div className="text-2xl font-bold text-cm-academic">1.2k</div>
              <div className="text-gray-600 text-xs">perguntas</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-cm-academic">3.4k</div>
              <div className="text-gray-600 text-xs">respostas</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-cm-academic">87%</div>
        ...
        <p className="mt-4 text-gray-700 text-sm max-w-3xl">
          ...
          Uma comunidade onde <em className="text-cm-academic font-medium">todas</em> as perguntas são bem-vindas.
        </p>
      </div>
    </div>
  );
