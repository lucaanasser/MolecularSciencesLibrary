      ...
      >
        ...
        >
          {shelfNumbers.map((shelfNum) => (
            <div
              key={shelfNum}
              className="bg-white rounded-lg shadow p-4 flex flex-col gap-2 min-w-[340px] w-[95vw] sm:min-w-[480px] sm:w-[480px] lg:min-w-[520px] lg:w-[520px] xl:min-w-[600px] xl:w-[600px]"
            >
