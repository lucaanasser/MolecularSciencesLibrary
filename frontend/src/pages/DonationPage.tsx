	...
	return (
		<div className="text-center text-2xl md:text-4xl font-bold flex flex-wrap justify-center items-center gap-2">
			...
			>
					...
					{displaySupporters.map((supporter, i) => (
						<div
							...
							className={`h-[3.5rem] flex items-center justify-center ${
								i === index + 2 ? "text-[#6C3EA5]" : "text-gray-400"
							}`}
						>
							{supporter}
						</div>
				...
				<div className="absolute top-0 h-[3.5rem] w-full bg-gradient-to-b from-white to-transparent pointer-events-none" />
				<div className="absolute bottom-0 h-[3.5rem] w-full bg-gradient-to-t from-white to-transparent pointer-events-none" />
			</div>
			...
			<div className="max-w-4xl mx-auto px-4">
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-16">
					...
					<div className="flex flex-col items-center text-center p-8 bg-white rounded-2xl shadow-md border border-gray-200">
						<div className="-mt-16 mb-4 flex items-center justify-center w-24 h-24 rounded-full bg-cm-green border-8 border-white">
					...
					<div className="flex flex-col items-center text-center p-8 bg-white rounded-2xl shadow-md border border-gray-200">
						<div className="-mt-16 mb-4 flex items-center justify-center w-24 h-24 rounded-full bg-cm-purple border-8 border-white">
						...
						<Button asChild className="w-full bg-cm-purple hover:bg-cm-purple/80 text-white rounded-xl font-bold py-3 mt-auto">
						...
						{products.map((product, idx) => (
							<div
								...
								className={`
									...
									rounded-3xl shadow-xl border-2 border-white/70
							...
							>
								<img
									...
									alt={product.name}
									className={`
										rounded-2xl border-4 border-white shadow-lg mb-2
								...
								<Button
									asChild
									className="bg-cm-purple/90 hover:bg-cm-purple text-white rounded-xl font-bold px-6 py-2 mt-auto shadow-md"
									style={{
										fontSize: "1rem",
										marginTop: "0.5rem",
				...
				<div className="text-center text-gray-700">
					...
					<Button asChild className="mt-8 bg-cm-purple hover:bg-cm-purple/80 text-white rounded-2xl px-10 py-4 text-lg font-bold">
						<Link to="/">Voltar para a Página Inicial</Link>
					</Button>
				</div>
				{/* Roleta de agradecimento aos apoiadores */}
				<div className="mt-24 flex flex-col items-center">
					<h2 className="text-3xl font-semibold mb-8 text-cm-purple">Agradecimento aos nossos apoiadores</h2>
					<SupportersCarousel />
				</div>
			</div>
		</section>
